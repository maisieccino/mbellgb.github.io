...
\subsection*{Career}
 ...
 \begin{itemize}
 	...
 	\begin{itemize*}
	    \item Working on various codebases across the stack, as part of the trading and operations team
	    \item Leading and mentoring the team on migrating from ECS + Salt stack to Kubernetes
	    \item Working a number of incident on-call rotas, getting exposure to the entire company's tech systems and fixing a wide array of issues.
